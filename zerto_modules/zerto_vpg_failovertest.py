#!/usr/bin/python
#Module to do FailoverTest by providing the vpg_vpgidentifier
#Author: Radheyshyam
...
def main():
    ...
    def doZertoFailoverTest():
        ...
        url = vpgs_url + '/' + vpg_vpgidentifier + '/FailoverTest'
        print("FOTE URL:: " + url)
        # Do FailoverTest by providing the vpg_vpgidentifier
    ...
    result_task_id= doZertoFailoverTest()
