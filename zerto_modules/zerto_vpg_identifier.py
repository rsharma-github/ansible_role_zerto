#!/usr/bin/python
#Module to get the VpgIdentifier
#Author: Radheyshyam
...
def main():
    ...
    return_vpg_id = getVpgIdentifier()
    module.exit_json(changed=True, vpg_id=return_vpg_id)
